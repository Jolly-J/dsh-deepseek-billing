window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/Python/DSH-Plug/harness-016/packages/extensions/dsh-deepseek-billing/src/client/BillingPanel.module.css.mjs
		const css = ".lUZAdW_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#80808059);background:var(--dsw-specific-sidebar-fill,var(--dsw-alias-bg-layer-1,#fff));width:calc(100% - 4px);min-width:0;max-width:calc(100% - 4px);color:var(--dsw-alias-label-primary,currentColor);border-radius:12px;flex:none;margin:0 2px 8px;padding:6px 12px;font-size:12px;line-height:1.55;overflow:hidden}.lUZAdW_head{cursor:pointer;user-select:none;align-items:center;gap:4px;display:flex}.lUZAdW_headLeft{flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow:hidden}.lUZAdW_spacer{flex:1 1 0;min-width:0}.lUZAdW_label{white-space:nowrap;flex:none;font-weight:700}.lUZAdW_value{white-space:nowrap;flex:none;align-items:center;display:inline-flex;overflow:hidden}.lUZAdW_valueSlot{text-align:left;white-space:nowrap;flex:none;align-items:center;width:4.2em;height:1.55em;display:inline-flex;overflow:hidden}.lUZAdW_iconBtn{color:inherit;opacity:.65;cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;align-items:center;padding:2px;font-size:12px;line-height:0;display:flex}.lUZAdW_iconBtn:hover{opacity:1;background:#8080802e}.lUZAdW_chevron{color:var(--dsw-alias-label-secondary,gray);flex:none;align-items:center;transition:transform .28s;display:flex;transform:rotate(0)}.lUZAdW_card.lUZAdW_expanded .lUZAdW_chevron{transform:rotate(180deg)}.lUZAdW_dot{background:var(--dsw-alias-state-warn-primary,#c9a227);border-radius:50%;flex:none;width:6px;height:6px}.lUZAdW_ok{background:var(--dsw-alias-state-success-primary,#2ea44f)}.lUZAdW_err{background:var(--dsw-alias-state-error-primary,#d9534f)}.lUZAdW_body{grid-template-rows:0fr;margin-top:0;transition:grid-template-rows .28s;display:grid}.lUZAdW_card.lUZAdW_expanded .lUZAdW_body{grid-template-rows:1fr;margin-top:8px}.lUZAdW_bodyInner{opacity:0;min-height:0;transition:opacity .22s;overflow:hidden}.lUZAdW_card.lUZAdW_expanded .lUZAdW_bodyInner{opacity:1}.lUZAdW_scroll{max-height:42vh;overflow:hidden auto}.lUZAdW_divider{background:var(--dsw-alias-border-l1,#8080803d);height:1px;margin:8px 0 6px}.lUZAdW_row{justify-content:space-between;align-items:center;gap:8px;display:flex}.lUZAdW_k{color:var(--dsw-alias-label-secondary,gray)}.lUZAdW_errText{color:var(--dsw-alias-state-error-primary,#d9534f)}.lUZAdW_note{color:var(--dsw-alias-label-secondary,gray);margin-top:4px;font-size:10.5px}.lUZAdW_sub{color:var(--dsw-alias-label-secondary,gray);font-size:11px}.lUZAdW_nowrap{white-space:nowrap;vertical-align:middle;align-items:center;height:1.55em;display:inline-flex;overflow:hidden}.lUZAdW_roll{white-space:nowrap;vertical-align:middle;align-items:center;height:1.55em;display:inline-flex;position:relative;overflow:hidden}.lUZAdW_rollOld{height:1.55em;animation:lUZAdW_dsb-roll-out .3s var(--ds-ease-in-out,cubic-bezier(.4, 0, .2, 1)) forwards;align-items:center;display:flex;position:absolute;top:0;right:0}.lUZAdW_rollNew{animation:lUZAdW_dsb-roll-in .3s var(--ds-ease-in-out,cubic-bezier(.4, 0, .2, 1));display:inline-block}@keyframes lUZAdW_dsb-roll-out{0%{opacity:1;transform:translateY(0)}to{opacity:0;transform:translateY(-100%)}}@keyframes lUZAdW_dsb-roll-in{0%{opacity:0;transform:translateY(100%)}to{opacity:1;transform:translateY(0)}}";
		...
		var BillingPanel_module_css_default = {
			"body": "lUZAdW_body",
			"bodyInner": "lUZAdW_bodyInner",
			"card": "lUZAdW_card",
			"chevron": "lUZAdW_chevron",
			"divider": "lUZAdW_divider",
			"dot": "lUZAdW_dot",
			"dsb-roll-in": "lUZAdW_dsb-roll-in",
			"dsb-roll-out": "lUZAdW_dsb-roll-out",
			"err": "lUZAdW_err",
			"errText": "lUZAdW_errText",
			"expanded": "lUZAdW_expanded",
			"head": "lUZAdW_head",
			"headLeft": "lUZAdW_headLeft",
			"iconBtn": "lUZAdW_iconBtn",
			"k": "lUZAdW_k",
			"label": "lUZAdW_label",
			"note": "lUZAdW_note",
			"nowrap": "lUZAdW_nowrap",
			"ok": "lUZAdW_ok",
			"roll": "lUZAdW_roll",
			"rollNew": "lUZAdW_rollNew",
			"rollOld": "lUZAdW_rollOld",
			"row": "lUZAdW_row",
			"scroll": "lUZAdW_scroll",
			"spacer": "lUZAdW_spacer",
			"sub": "lUZAdW_sub",
			"value": "lUZAdW_value",
			"valueSlot": "lUZAdW_valueSlot"
		};
		//#endregion
		...
		*/
		function selectActiveSessionId(list) {
			if (list === null || list === void 0) return null;
			const retained = Object.values(list.byId ?? {}).find((row) => (row?.retainedBy?.mainView ?? 0) > 0);
			if (retained !== void 0 && retained !== null) return String(retained.id);
			const legacy = list.current;
			return legacy === void 0 || legacy === null ? null : String(legacy);
		}
		//#endregion
