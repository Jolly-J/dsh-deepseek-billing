window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/Python/DSH-Plug/harness-current/packages/extensions/dsh-deepseek-billing/src/client/BillingPanel.module.css.mjs
		const css = ".ZlON4a_card{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#80808059);background:var(--dsw-specific-sidebar-fill,var(--dsw-alias-bg-layer-1,#fff));width:calc(100% - 4px);min-width:0;max-width:calc(100% - 4px);color:var(--dsw-alias-label-primary,currentColor);border-radius:12px;flex:none;margin:0 2px 8px;padding:6px 12px;font-size:12px;line-height:1.55;overflow:hidden}.ZlON4a_head{cursor:pointer;user-select:none;align-items:center;gap:4px;display:flex}.ZlON4a_headLeft{flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow:hidden}.ZlON4a_spacer{flex:1 1 0;min-width:0}.ZlON4a_label{white-space:nowrap;flex:none;font-weight:700}.ZlON4a_value{white-space:nowrap;flex:none;align-items:center;display:inline-flex;overflow:hidden}.ZlON4a_valueSlot{text-align:left;white-space:nowrap;flex:none;align-items:center;width:4.2em;height:1.55em;display:inline-flex;overflow:hidden}.ZlON4a_iconBtn{color:inherit;opacity:.65;cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;align-items:center;padding:2px;font-size:12px;line-height:0;display:flex}.ZlON4a_iconBtn:hover{opacity:1;background:#8080802e}.ZlON4a_chevron{color:var(--dsw-alias-label-secondary,gray);flex:none;align-items:center;transition:transform .28s;display:flex;transform:rotate(0)}.ZlON4a_card.ZlON4a_expanded .ZlON4a_chevron{transform:rotate(180deg)}.ZlON4a_dot{background:var(--dsw-alias-state-warn-primary,#c9a227);border-radius:50%;flex:none;width:6px;height:6px}.ZlON4a_ok{background:var(--dsw-alias-state-success-primary,#2ea44f)}.ZlON4a_err{background:var(--dsw-alias-state-error-primary,#d9534f)}.ZlON4a_body{grid-template-rows:0fr;margin-top:0;transition:grid-template-rows .28s;display:grid}.ZlON4a_card.ZlON4a_expanded .ZlON4a_body{grid-template-rows:1fr;margin-top:8px}.ZlON4a_bodyInner{opacity:0;min-height:0;transition:opacity .22s;overflow:hidden}.ZlON4a_card.ZlON4a_expanded .ZlON4a_bodyInner{opacity:1}.ZlON4a_scroll{max-height:42vh;overflow:hidden auto}.ZlON4a_divider{background:var(--dsw-alias-border-l1,#8080803d);height:1px;margin:8px 0 6px}.ZlON4a_row{justify-content:space-between;align-items:center;gap:8px;display:flex}.ZlON4a_k{color:var(--dsw-alias-label-secondary,gray)}.ZlON4a_errText{color:var(--dsw-alias-state-error-primary,#d9534f)}.ZlON4a_note{color:var(--dsw-alias-label-secondary,gray);margin-top:4px;font-size:10.5px}.ZlON4a_sub{color:var(--dsw-alias-label-secondary,gray);font-size:11px}.ZlON4a_nowrap{white-space:nowrap;vertical-align:middle;align-items:center;height:1.55em;display:inline-flex;overflow:hidden}.ZlON4a_roll{white-space:nowrap;vertical-align:middle;align-items:center;height:1.55em;display:inline-flex;position:relative;overflow:hidden}.ZlON4a_rollOld{height:1.55em;animation:ZlON4a_dsb-roll-out .3s var(--ds-ease-in-out,cubic-bezier(.4, 0, .2, 1)) forwards;align-items:center;display:flex;position:absolute;top:0;right:0}.ZlON4a_rollNew{animation:ZlON4a_dsb-roll-in .3s var(--ds-ease-in-out,cubic-bezier(.4, 0, .2, 1));display:inline-block}@keyframes ZlON4a_dsb-roll-out{0%{opacity:1;transform:translateY(0)}to{opacity:0;transform:translateY(-100%)}}@keyframes ZlON4a_dsb-roll-in{0%{opacity:0;transform:translateY(100%)}to{opacity:1;transform:translateY(0)}}";
		...
		var BillingPanel_module_css_default = {
			"body": "ZlON4a_body",
			"bodyInner": "ZlON4a_bodyInner",
			"card": "ZlON4a_card",
			"chevron": "ZlON4a_chevron",
			"divider": "ZlON4a_divider",
			"dot": "ZlON4a_dot",
			"dsb-roll-in": "ZlON4a_dsb-roll-in",
			"dsb-roll-out": "ZlON4a_dsb-roll-out",
			"err": "ZlON4a_err",
			"errText": "ZlON4a_errText",
			"expanded": "ZlON4a_expanded",
			"head": "ZlON4a_head",
			"headLeft": "ZlON4a_headLeft",
			"iconBtn": "ZlON4a_iconBtn",
			"k": "ZlON4a_k",
			"label": "ZlON4a_label",
			"note": "ZlON4a_note",
			"nowrap": "ZlON4a_nowrap",
			"ok": "ZlON4a_ok",
			"roll": "ZlON4a_roll",
			"rollNew": "ZlON4a_rollNew",
			"rollOld": "ZlON4a_rollOld",
			"row": "ZlON4a_row",
			"scroll": "ZlON4a_scroll",
			"spacer": "ZlON4a_spacer",
			"sub": "ZlON4a_sub",
			"value": "ZlON4a_value",
			"valueSlot": "ZlON4a_valueSlot"
		};
		//#endregion
